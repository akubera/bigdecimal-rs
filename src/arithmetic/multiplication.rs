...
pub(crate) fn multiply_slices_with_prec_into_p19(
    ...
    let bigdigits_to_skip = R::div_digits(digits_to_skip)
    ...
    let max_sigproduct_bigdigit_count = R::div_digits(a_sig_digit_count + b_sig_digit_count + 1);
    let mut product =
...
fn calculate_partial_product_trailing_zeros(
    ...
    // than the maximum overflow from one iteration of preceeding digits
