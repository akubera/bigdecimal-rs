...
pub(crate) fn impl_pow_with_context(bd: &BigDecimal, exp: u32, ctx: &Context) -> BigDecimal {
    if exp == 0 {
        return 1.into();
    }
...
mod test {
    ...
    mod pow_known {
        ...
        impl_case!(case_2_minus30000000: BigDecimal::from(2).inverse(), 30000000 => "1.34921314623699835510360889355448887159595110457423959780496317685705095413905406464421931122265203166201415504288117880522818881981650e-9030900");
    }
    ...
    mod pow_misc {
        ...
        // get the same number (scaling down the 500 precision result to 50).

        impl_case!(case_misc_1: "-1.87421916986125215986", 3000912415);
